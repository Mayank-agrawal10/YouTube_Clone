...
const PlayVideo = () => {
    ...
    const [commentdData, SetCommentData] = useState([])
        ...
        <div className="play-video" >
            ...
            <div className="publisher">
                ...
                <div>
                    ...
                    <span>{channelData ? value_converter(channelData.statistics.subscriberCount) : "1M"} Subscribers
                    </span>
                </div>
            ...
            <div className="vid-description">
                ...
                {commentdData.map((item, index) => {
                    return (
                        <div key={index} className="comment">
                            <img src={item.snippet.topLevelComment.snippet.authorProfileImageUrl} alt="" />
                            <div>
                                <h3>{item.snippet.topLevelComment.snippet.authorDisplayName} <span>
                                    {moment(item.snippet.topLevelComment.snippet.publishedAt).fromNow()}</span></h3>
                                <p>
